...
# https://raw.githubusercontent.com/blumenthal/ropod-base-cpp/master/install_deps.sh
# Some changes are made to install newer versions of libsodium
...
cd pyzmq && sudo python3 setup.py install
cd ..

git clone https://github.com/ropod-project/pyre.git
cd pyre && sudo python3 setup.py install
cd ..

git clone https://github.com/ropod-project/zyre_base.git
cd zyre_base && sudo python3 setup.py install
cd ..

git clone https://github.com/ropod-project/ropod_common.git
cd ropod_common/pyropod && sudo python3 setup.py develop
